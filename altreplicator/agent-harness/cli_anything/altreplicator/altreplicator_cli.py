...
from cli_anything.altreplicator.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altreplicator.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altreplicator",version="1.0.0");skin.print_banner()
