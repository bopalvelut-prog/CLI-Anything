...
from cli_anything.aero_balancer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_balancer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-balancer",version="1.0.0");skin.print_banner()
