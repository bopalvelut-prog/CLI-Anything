...
from cli_anything.agritheme.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agritheme.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agritheme",version="1.0.0");skin.print_banner()
