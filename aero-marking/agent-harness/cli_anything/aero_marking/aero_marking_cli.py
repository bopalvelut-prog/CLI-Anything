...
from cli_anything.aero_marking.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_marking.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-marking",version="1.0.0");skin.print_banner()
