...
from cli_anything.altbridge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altbridge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altbridge",version="1.0.0");skin.print_banner()
