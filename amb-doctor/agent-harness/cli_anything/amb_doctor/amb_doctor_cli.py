...
from cli_anything.amb_doctor.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_doctor.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-doctor",version="1.0.0");skin.print_banner()
