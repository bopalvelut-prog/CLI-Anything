...
from cli_anything.amb_recommender.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_recommender.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-recommender",version="1.0.0");skin.print_banner()
