...
from cli_anything.amb_pipeline.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_pipeline.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-pipeline",version="1.0.0");skin.print_banner()
