...
from cli_anything.aeroprofessional.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroprofessional.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroprofessional",version="1.0.0");skin.print_banner()
