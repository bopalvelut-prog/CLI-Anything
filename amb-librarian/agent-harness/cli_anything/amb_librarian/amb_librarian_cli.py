...
from cli_anything.amb_librarian.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_librarian.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-librarian",version="1.0.0");skin.print_banner()
