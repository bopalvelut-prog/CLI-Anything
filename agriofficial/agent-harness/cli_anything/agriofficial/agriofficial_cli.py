...
from cli_anything.agriofficial.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriofficial.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriofficial",version="1.0.0");skin.print_banner()
