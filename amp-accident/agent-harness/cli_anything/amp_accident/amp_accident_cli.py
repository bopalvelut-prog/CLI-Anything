...
from cli_anything.amp_accident.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amp_accident.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amp-accident",version="1.0.0");skin.print_banner()
