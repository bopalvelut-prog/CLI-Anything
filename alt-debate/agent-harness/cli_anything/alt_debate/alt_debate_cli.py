...
from cli_anything.alt_debate.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_debate.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-debate",version="1.0.0");skin.print_banner()
