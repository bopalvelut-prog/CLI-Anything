...
from cli_anything.agri_executive.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_executive.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-executive",version="1.0.0");skin.print_banner()
