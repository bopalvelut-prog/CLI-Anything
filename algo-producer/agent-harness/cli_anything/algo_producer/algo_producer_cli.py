...
from cli_anything.algo_producer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_producer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-producer",version="1.0.0");skin.print_banner()
