...
from cli_anything.aerosurvey.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerosurvey.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerosurvey",version="1.0.0");skin.print_banner()
