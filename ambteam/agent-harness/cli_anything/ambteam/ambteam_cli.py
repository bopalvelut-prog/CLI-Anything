...
from cli_anything.ambteam.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambteam.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambteam",version="1.0.0");skin.print_banner()
