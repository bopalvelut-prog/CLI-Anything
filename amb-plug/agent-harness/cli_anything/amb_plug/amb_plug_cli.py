...
from cli_anything.amb_plug.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_plug.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-plug",version="1.0.0");skin.print_banner()
