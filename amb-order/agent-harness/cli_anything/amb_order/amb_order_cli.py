...
from cli_anything.amb_order.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_order.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-order",version="1.0.0");skin.print_banner()
