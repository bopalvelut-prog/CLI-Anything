...
from cli_anything.alt_pusher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_pusher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-pusher",version="1.0.0");skin.print_banner()
