...
from cli_anything.ambcustodian.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambcustodian.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambcustodian",version="1.0.0");skin.print_banner()
