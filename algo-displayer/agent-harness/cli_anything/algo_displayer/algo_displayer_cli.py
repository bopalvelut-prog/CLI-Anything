...
from cli_anything.algo_displayer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_displayer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-displayer",version="1.0.0");skin.print_banner()
