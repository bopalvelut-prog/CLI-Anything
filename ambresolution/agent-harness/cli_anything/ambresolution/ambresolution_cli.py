...
from cli_anything.ambresolution.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambresolution.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambresolution",version="1.0.0");skin.print_banner()
