...
from cli_anything.alt_act.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_act.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-act",version="1.0.0");skin.print_banner()
