...
from cli_anything.aerotechnician.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerotechnician.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerotechnician",version="1.0.0");skin.print_banner()
