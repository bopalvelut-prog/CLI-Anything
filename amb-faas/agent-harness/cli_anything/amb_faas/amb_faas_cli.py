...
from cli_anything.amb_faas.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_faas.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-faas",version="1.0.0");skin.print_banner()
