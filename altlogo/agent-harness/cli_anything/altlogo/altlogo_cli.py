...
from cli_anything.altlogo.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altlogo.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altlogo",version="1.0.0");skin.print_banner()
