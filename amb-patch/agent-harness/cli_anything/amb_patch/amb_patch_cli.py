...
from cli_anything.amb_patch.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_patch.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-patch",version="1.0.0");skin.print_banner()
