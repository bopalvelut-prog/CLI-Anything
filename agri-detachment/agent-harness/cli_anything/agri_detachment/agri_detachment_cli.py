...
from cli_anything.agri_detachment.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_detachment.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-detachment",version="1.0.0");skin.print_banner()
