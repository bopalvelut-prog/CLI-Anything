...
from cli_anything.algo_authority.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_authority.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-authority",version="1.0.0");skin.print_banner()
