...
from cli_anything.altbalancer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altbalancer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altbalancer",version="1.0.0");skin.print_banner()
