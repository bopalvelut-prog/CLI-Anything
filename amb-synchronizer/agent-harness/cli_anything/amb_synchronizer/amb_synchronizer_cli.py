...
from cli_anything.amb_synchronizer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_synchronizer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-synchronizer",version="1.0.0");skin.print_banner()
