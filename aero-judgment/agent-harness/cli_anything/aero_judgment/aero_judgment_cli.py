...
from cli_anything.aero_judgment.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_judgment.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-judgment",version="1.0.0");skin.print_banner()
