...
from cli_anything.agrilabel.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrilabel.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrilabel",version="1.0.0");skin.print_banner()
