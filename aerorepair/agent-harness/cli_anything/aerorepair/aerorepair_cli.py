...
from cli_anything.aerorepair.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerorepair.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerorepair",version="1.0.0");skin.print_banner()
