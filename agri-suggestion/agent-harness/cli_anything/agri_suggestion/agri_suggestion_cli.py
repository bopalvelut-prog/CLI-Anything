...
from cli_anything.agri_suggestion.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_suggestion.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-suggestion",version="1.0.0");skin.print_banner()
