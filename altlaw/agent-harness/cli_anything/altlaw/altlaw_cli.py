...
from cli_anything.altlaw.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altlaw.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altlaw",version="1.0.0");skin.print_banner()
