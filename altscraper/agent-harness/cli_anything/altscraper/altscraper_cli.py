...
from cli_anything.altscraper.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altscraper.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altscraper",version="1.0.0");skin.print_banner()
