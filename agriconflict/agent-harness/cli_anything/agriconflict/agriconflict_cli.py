...
from cli_anything.agriconflict.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriconflict.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriconflict",version="1.0.0");skin.print_banner()
