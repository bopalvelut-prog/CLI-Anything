...
from cli_anything.agri_font.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_font.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-font",version="1.0.0");skin.print_banner()
