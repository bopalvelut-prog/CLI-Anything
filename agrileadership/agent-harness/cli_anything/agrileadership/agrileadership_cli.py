...
from cli_anything.agrileadership.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrileadership.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrileadership",version="1.0.0");skin.print_banner()
