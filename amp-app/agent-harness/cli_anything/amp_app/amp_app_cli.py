...
from cli_anything.amp_app.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amp_app.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amp-app",version="1.0.0");skin.print_banner()
