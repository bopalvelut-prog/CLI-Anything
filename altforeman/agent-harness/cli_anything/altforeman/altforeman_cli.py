...
from cli_anything.altforeman.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altforeman.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altforeman",version="1.0.0");skin.print_banner()
