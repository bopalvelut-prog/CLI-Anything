...
from cli_anything.algo_dev.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_dev.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-dev",version="1.0.0");skin.print_banner()
