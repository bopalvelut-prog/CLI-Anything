...
from cli_anything.agri_renderer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_renderer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-renderer",version="1.0.0");skin.print_banner()
