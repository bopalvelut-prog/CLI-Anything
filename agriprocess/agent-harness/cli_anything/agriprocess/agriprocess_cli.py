...
from cli_anything.agriprocess.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriprocess.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriprocess",version="1.0.0");skin.print_banner()
