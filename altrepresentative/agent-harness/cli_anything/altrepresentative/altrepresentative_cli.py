...
from cli_anything.altrepresentative.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altrepresentative.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altrepresentative",version="1.0.0");skin.print_banner()
