...
from cli_anything.amb_test.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_test.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-test",version="1.0.0");skin.print_banner()
