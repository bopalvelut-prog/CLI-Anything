...
from cli_anything.aero_approach.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_approach.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-approach",version="1.0.0");skin.print_banner()
