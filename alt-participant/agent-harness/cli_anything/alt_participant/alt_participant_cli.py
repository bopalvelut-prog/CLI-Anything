...
from cli_anything.alt_participant.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_participant.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-participant",version="1.0.0");skin.print_banner()
