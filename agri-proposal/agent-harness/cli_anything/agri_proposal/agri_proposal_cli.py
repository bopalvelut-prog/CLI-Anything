...
from cli_anything.agri_proposal.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_proposal.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-proposal",version="1.0.0");skin.print_banner()
