...
from cli_anything.aero_explainer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_explainer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-explainer",version="1.0.0");skin.print_banner()
