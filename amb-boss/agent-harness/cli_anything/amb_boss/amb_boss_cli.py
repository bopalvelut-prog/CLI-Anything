...
from cli_anything.amb_boss.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_boss.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-boss",version="1.0.0");skin.print_banner()
