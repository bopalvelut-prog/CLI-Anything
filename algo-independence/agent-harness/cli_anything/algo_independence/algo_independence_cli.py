...
from cli_anything.algo_independence.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_independence.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-independence",version="1.0.0");skin.print_banner()
