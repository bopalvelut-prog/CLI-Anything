...
from cli_anything.alt_recv.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_recv.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-recv",version="1.0.0");skin.print_banner()
