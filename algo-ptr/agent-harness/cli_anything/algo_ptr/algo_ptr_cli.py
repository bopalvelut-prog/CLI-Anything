...
from cli_anything.algo_ptr.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_ptr.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-ptr",version="1.0.0");skin.print_banner()
