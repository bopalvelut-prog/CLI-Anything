...
from cli_anything.aero_personnel.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_personnel.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-personnel",version="1.0.0");skin.print_banner()
