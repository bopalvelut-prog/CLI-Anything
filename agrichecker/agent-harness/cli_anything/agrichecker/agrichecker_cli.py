...
from cli_anything.agrichecker.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrichecker.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrichecker",version="1.0.0");skin.print_banner()
