...
from cli_anything.ambparser.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambparser.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambparser",version="1.0.0");skin.print_banner()
