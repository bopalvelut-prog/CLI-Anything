...
from cli_anything.aerosupporter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerosupporter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerosupporter",version="1.0.0");skin.print_banner()
