...
from cli_anything.ambhearing.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambhearing.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambhearing",version="1.0.0");skin.print_banner()
