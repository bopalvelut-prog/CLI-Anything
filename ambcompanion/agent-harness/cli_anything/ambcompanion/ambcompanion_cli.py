...
from cli_anything.ambcompanion.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambcompanion.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambcompanion",version="1.0.0");skin.print_banner()
