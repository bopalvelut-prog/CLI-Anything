...
from cli_anything.aeromenu.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeromenu.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeromenu",version="1.0.0");skin.print_banner()
