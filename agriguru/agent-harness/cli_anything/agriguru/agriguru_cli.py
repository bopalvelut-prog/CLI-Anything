...
from cli_anything.agriguru.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriguru.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriguru",version="1.0.0");skin.print_banner()
