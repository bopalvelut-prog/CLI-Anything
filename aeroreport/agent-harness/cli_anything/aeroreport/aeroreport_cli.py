...
from cli_anything.aeroreport.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroreport.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroreport",version="1.0.0");skin.print_banner()
