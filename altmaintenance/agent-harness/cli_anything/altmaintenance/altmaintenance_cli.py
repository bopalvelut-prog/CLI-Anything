...
from cli_anything.altmaintenance.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altmaintenance.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altmaintenance",version="1.0.0");skin.print_banner()
