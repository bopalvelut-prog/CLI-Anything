...
from cli_anything.alt_conflict.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_conflict.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-conflict",version="1.0.0");skin.print_banner()
