...
from cli_anything.aero_executive.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_executive.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-executive",version="1.0.0");skin.print_banner()
