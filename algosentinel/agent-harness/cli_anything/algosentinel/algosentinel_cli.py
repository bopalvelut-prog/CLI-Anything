...
from cli_anything.algosentinel.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algosentinel.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algosentinel",version="1.0.0");skin.print_banner()
