...
from cli_anything.aero_captain.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_captain.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-captain",version="1.0.0");skin.print_banner()
