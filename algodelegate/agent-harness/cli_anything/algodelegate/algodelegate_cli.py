...
from cli_anything.algodelegate.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algodelegate.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algodelegate",version="1.0.0");skin.print_banner()
