...
from cli_anything.amb_senate.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_senate.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-senate",version="1.0.0");skin.print_banner()
