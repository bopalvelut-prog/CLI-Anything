...
from cli_anything.aero_matter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_matter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-matter",version="1.0.0");skin.print_banner()
