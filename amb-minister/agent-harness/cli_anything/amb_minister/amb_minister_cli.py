...
from cli_anything.amb_minister.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_minister.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-minister",version="1.0.0");skin.print_banner()
