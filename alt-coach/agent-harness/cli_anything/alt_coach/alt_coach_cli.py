...
from cli_anything.alt_coach.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_coach.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-coach",version="1.0.0");skin.print_banner()
