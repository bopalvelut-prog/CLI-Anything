...
from cli_anything.agri_procedure.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_procedure.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-procedure",version="1.0.0");skin.print_banner()
