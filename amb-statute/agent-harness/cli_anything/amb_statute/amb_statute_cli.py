...
from cli_anything.amb_statute.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_statute.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-statute",version="1.0.0");skin.print_banner()
