...
from cli_anything.agrimark.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrimark.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrimark",version="1.0.0");skin.print_banner()
