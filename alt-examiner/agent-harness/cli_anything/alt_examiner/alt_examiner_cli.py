...
from cli_anything.alt_examiner.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_examiner.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-examiner",version="1.0.0");skin.print_banner()
