...
from cli_anything.agrigeneral.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrigeneral.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrigeneral",version="1.0.0");skin.print_banner()
