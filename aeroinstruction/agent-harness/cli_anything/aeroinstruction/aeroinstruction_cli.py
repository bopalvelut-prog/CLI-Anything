...
from cli_anything.aeroinstruction.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroinstruction.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroinstruction",version="1.0.0");skin.print_banner()
