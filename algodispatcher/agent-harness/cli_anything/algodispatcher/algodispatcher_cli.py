...
from cli_anything.algodispatcher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algodispatcher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algodispatcher",version="1.0.0");skin.print_banner()
