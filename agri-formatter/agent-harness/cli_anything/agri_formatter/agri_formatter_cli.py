...
from cli_anything.agri_formatter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_formatter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-formatter",version="1.0.0");skin.print_banner()
