...
from cli_anything.altstore.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altstore.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altstore",version="1.0.0");skin.print_banner()
