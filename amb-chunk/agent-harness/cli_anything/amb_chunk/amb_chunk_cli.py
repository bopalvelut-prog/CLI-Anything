...
from cli_anything.amb_chunk.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_chunk.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-chunk",version="1.0.0");skin.print_banner()
