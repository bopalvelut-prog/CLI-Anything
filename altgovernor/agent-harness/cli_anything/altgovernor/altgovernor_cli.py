...
from cli_anything.altgovernor.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altgovernor.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altgovernor",version="1.0.0");skin.print_banner()
