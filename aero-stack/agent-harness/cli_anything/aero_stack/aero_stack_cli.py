...
from cli_anything.aero_stack.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_stack.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-stack",version="1.0.0");skin.print_banner()
