...
from cli_anything.aerodesign.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerodesign.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerodesign",version="1.0.0");skin.print_banner()
