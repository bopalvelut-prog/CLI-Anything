...
from cli_anything.algo_matcher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_matcher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-matcher",version="1.0.0");skin.print_banner()
