...
from cli_anything.altlabor.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altlabor.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altlabor",version="1.0.0");skin.print_banner()
