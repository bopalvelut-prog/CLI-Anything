...
from cli_anything.altwatcher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altwatcher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altwatcher",version="1.0.0");skin.print_banner()
