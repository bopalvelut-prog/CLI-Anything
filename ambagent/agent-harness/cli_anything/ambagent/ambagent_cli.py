...
from cli_anything.ambagent.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambagent.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambagent",version="1.0.0");skin.print_banner()
