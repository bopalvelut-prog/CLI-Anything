...
from cli_anything.amb_challenge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_challenge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-challenge",version="1.0.0");skin.print_banner()
