...
from cli_anything.amb_pack.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_pack.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-pack",version="1.0.0");skin.print_banner()
