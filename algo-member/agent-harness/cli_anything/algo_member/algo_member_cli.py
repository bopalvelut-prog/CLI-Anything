...
from cli_anything.algo_member.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_member.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-member",version="1.0.0");skin.print_banner()
