...
from cli_anything.aero_ally.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_ally.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-ally",version="1.0.0");skin.print_banner()
