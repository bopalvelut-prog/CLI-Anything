...
from cli_anything.ambcounter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambcounter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambcounter",version="1.0.0");skin.print_banner()
