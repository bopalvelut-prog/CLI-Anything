...
from cli_anything.algodirector.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algodirector.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algodirector",version="1.0.0");skin.print_banner()
