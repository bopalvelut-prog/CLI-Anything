...
from cli_anything.aeroci.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroci.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroci",version="1.0.0");skin.print_banner()
