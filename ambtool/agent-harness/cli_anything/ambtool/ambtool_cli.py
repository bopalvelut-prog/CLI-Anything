...
from cli_anything.ambtool.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambtool.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambtool",version="1.0.0");skin.print_banner()
