...
from cli_anything.agriact.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriact.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriact",version="1.0.0");skin.print_banner()
