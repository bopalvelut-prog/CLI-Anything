...
from cli_anything.aero_meeting.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_meeting.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-meeting",version="1.0.0");skin.print_banner()
