...
from cli_anything.altsurvey.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altsurvey.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altsurvey",version="1.0.0");skin.print_banner()
