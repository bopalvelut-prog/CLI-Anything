...
from cli_anything.altpage.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altpage.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altpage",version="1.0.0");skin.print_banner()
