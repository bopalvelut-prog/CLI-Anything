...
from cli_anything.amb_admiral.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_admiral.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-admiral",version="1.0.0");skin.print_banner()
