...
from cli_anything.aerobalancer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerobalancer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerobalancer",version="1.0.0");skin.print_banner()
