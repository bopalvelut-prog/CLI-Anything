...
from cli_anything.agripresident.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agripresident.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agripresident",version="1.0.0");skin.print_banner()
