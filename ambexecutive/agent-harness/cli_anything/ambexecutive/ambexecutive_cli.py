...
from cli_anything.ambexecutive.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambexecutive.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambexecutive",version="1.0.0");skin.print_banner()
