...
from cli_anything.agrihead.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrihead.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrihead",version="1.0.0");skin.print_banner()
