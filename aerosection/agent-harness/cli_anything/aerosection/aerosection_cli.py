...
from cli_anything.aerosection.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerosection.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerosection",version="1.0.0");skin.print_banner()
