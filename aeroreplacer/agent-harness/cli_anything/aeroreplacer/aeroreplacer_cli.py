...
from cli_anything.aeroreplacer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroreplacer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroreplacer",version="1.0.0");skin.print_banner()
