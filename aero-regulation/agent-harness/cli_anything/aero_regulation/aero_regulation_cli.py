...
from cli_anything.aero_regulation.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_regulation.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-regulation",version="1.0.0");skin.print_banner()
