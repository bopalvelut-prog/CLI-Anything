...
from cli_anything.aero_bridge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_bridge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-bridge",version="1.0.0");skin.print_banner()
