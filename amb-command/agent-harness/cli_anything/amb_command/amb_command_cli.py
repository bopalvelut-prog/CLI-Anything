...
from cli_anything.amb_command.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_command.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-command",version="1.0.0");skin.print_banner()
