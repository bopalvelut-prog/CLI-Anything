...
from cli_anything.agri_review.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_review.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-review",version="1.0.0");skin.print_banner()
