...
from cli_anything.amb_designer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_designer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-designer",version="1.0.0");skin.print_banner()
