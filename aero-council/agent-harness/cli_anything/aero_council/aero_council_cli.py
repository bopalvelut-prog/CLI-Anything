...
from cli_anything.aero_council.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_council.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-council",version="1.0.0");skin.print_banner()
