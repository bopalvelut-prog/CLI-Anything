...
from cli_anything.algo_searcher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_searcher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-searcher",version="1.0.0");skin.print_banner()
