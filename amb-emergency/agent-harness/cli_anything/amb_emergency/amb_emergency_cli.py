...
from cli_anything.amb_emergency.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_emergency.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-emergency",version="1.0.0");skin.print_banner()
