...
from cli_anything.algo_block.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_block.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-block",version="1.0.0");skin.print_banner()
