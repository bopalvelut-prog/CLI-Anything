...
from cli_anything.aero_sovereignty.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_sovereignty.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-sovereignty",version="1.0.0");skin.print_banner()
