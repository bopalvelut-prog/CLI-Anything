...
from cli_anything.amb_builder.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_builder.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-builder",version="1.0.0");skin.print_banner()
