...
from cli_anything.aeroprocessor.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroprocessor.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroprocessor",version="1.0.0");skin.print_banner()
