...
from cli_anything.agri_regulation.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_regulation.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-regulation",version="1.0.0");skin.print_banner()
