...
from cli_anything.algo_audit.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_audit.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-audit",version="1.0.0");skin.print_banner()
