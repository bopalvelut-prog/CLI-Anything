...
from cli_anything.algo_scheme.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_scheme.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-scheme",version="1.0.0");skin.print_banner()
