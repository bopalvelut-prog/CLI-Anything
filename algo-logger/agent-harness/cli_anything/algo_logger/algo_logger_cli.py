...
from cli_anything.algo_logger.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_logger.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-logger",version="1.0.0");skin.print_banner()
