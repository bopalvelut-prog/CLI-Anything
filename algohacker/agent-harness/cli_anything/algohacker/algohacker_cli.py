...
from cli_anything.algohacker.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algohacker.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algohacker",version="1.0.0");skin.print_banner()
