...
from cli_anything.agri_cap.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_cap.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-cap",version="1.0.0");skin.print_banner()
