...
from cli_anything.agriblueprint.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriblueprint.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriblueprint",version="1.0.0");skin.print_banner()
