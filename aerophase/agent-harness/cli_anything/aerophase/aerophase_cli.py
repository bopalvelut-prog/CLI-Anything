...
from cli_anything.aerophase.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerophase.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerophase",version="1.0.0");skin.print_banner()
