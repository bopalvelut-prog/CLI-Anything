...
from cli_anything.agriscanner.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriscanner.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriscanner",version="1.0.0");skin.print_banner()
