...
from cli_anything.algo_increase.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_increase.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-increase",version="1.0.0");skin.print_banner()
