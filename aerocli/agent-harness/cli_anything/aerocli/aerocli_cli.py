...
from cli_anything.aerocli.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerocli.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerocli",version="1.0.0");skin.print_banner()
