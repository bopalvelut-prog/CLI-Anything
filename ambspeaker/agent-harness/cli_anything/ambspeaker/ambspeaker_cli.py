...
from cli_anything.ambspeaker.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambspeaker.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambspeaker",version="1.0.0");skin.print_banner()
