...
from cli_anything.aeromaintenance.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeromaintenance.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeromaintenance",version="1.0.0");skin.print_banner()
