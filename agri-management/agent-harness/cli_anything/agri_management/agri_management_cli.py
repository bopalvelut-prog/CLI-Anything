...
from cli_anything.agri_management.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_management.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-management",version="1.0.0");skin.print_banner()
