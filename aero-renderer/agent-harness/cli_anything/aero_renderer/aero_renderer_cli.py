...
from cli_anything.aero_renderer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_renderer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-renderer",version="1.0.0");skin.print_banner()
