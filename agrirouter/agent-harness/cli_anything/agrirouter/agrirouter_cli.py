...
from cli_anything.agrirouter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrirouter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrirouter",version="1.0.0");skin.print_banner()
