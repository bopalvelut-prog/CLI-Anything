...
from cli_anything.amb_replacer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_replacer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-replacer",version="1.0.0");skin.print_banner()
