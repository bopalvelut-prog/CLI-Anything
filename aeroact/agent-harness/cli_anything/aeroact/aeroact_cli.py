...
from cli_anything.aeroact.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroact.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroact",version="1.0.0");skin.print_banner()
