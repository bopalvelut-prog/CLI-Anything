...
from cli_anything.aero_minister.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_minister.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-minister",version="1.0.0");skin.print_banner()
