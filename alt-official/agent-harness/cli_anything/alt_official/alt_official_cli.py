...
from cli_anything.alt_official.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_official.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-official",version="1.0.0");skin.print_banner()
