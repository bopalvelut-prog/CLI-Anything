...
from cli_anything.agri_proxy.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_proxy.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-proxy",version="1.0.0");skin.print_banner()
