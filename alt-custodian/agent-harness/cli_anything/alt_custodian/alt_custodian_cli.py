...
from cli_anything.alt_custodian.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_custodian.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-custodian",version="1.0.0");skin.print_banner()
