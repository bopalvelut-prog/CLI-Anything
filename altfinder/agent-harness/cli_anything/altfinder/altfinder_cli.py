...
from cli_anything.altfinder.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altfinder.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altfinder",version="1.0.0");skin.print_banner()
