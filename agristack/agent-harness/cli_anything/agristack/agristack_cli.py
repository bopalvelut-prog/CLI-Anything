...
from cli_anything.agristack.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agristack.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agristack",version="1.0.0");skin.print_banner()
