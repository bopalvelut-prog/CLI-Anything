...
from cli_anything.algo_puller.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_puller.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-puller",version="1.0.0");skin.print_banner()
