...
from cli_anything.aero_commander_in_chief.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_commander_in_chief.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-commander-in-chief",version="1.0.0");skin.print_banner()
