...
from cli_anything.agrimanager.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrimanager.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrimanager",version="1.0.0");skin.print_banner()
