...
from cli_anything.amp_bot.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amp_bot.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amp-bot",version="1.0.0");skin.print_banner()
