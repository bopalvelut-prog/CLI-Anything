...
from cli_anything.algo_panel.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_panel.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-panel",version="1.0.0");skin.print_banner()
