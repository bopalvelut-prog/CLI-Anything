...
from cli_anything.aeroprocedure.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroprocedure.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroprocedure",version="1.0.0");skin.print_banner()
