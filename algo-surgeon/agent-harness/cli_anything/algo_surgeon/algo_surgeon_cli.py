...
from cli_anything.algo_surgeon.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_surgeon.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-surgeon",version="1.0.0");skin.print_banner()
