...
from cli_anything.amb_engineer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_engineer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-engineer",version="1.0.0");skin.print_banner()
