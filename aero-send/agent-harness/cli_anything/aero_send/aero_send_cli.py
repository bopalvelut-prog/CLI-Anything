...
from cli_anything.aero_send.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_send.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-send",version="1.0.0");skin.print_banner()
