...
from cli_anything.amp_appraisal.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amp_appraisal.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amp-appraisal",version="1.0.0");skin.print_banner()
