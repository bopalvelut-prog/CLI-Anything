...
from cli_anything.amb_committee.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_committee.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-committee",version="1.0.0");skin.print_banner()
