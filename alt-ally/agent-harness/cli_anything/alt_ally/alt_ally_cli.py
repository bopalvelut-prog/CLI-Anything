...
from cli_anything.alt_ally.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_ally.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-ally",version="1.0.0");skin.print_banner()
