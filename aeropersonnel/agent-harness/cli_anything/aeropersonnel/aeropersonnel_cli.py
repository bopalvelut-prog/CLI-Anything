...
from cli_anything.aeropersonnel.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeropersonnel.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeropersonnel",version="1.0.0");skin.print_banner()
