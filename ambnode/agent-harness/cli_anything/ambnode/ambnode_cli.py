...
from cli_anything.ambnode.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambnode.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambnode",version="1.0.0");skin.print_banner()
