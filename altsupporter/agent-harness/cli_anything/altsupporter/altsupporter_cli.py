...
from cli_anything.altsupporter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altsupporter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altsupporter",version="1.0.0");skin.print_banner()
