...
from cli_anything.agri_chunk.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_chunk.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-chunk",version="1.0.0");skin.print_banner()
