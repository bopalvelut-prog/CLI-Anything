...
from cli_anything.amb_update.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_update.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-update",version="1.0.0");skin.print_banner()
