...
from cli_anything.agriscraper.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriscraper.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriscraper",version="1.0.0");skin.print_banner()
