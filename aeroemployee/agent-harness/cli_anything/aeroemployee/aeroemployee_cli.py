...
from cli_anything.aeroemployee.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aeroemployee.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aeroemployee",version="1.0.0");skin.print_banner()
