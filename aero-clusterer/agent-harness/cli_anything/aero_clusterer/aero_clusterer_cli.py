...
from cli_anything.aero_clusterer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_clusterer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-clusterer",version="1.0.0");skin.print_banner()
