...
from cli_anything.aero_mayor.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_mayor.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-mayor",version="1.0.0");skin.print_banner()
