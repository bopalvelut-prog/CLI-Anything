...
from cli_anything.aerochallenge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerochallenge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerochallenge",version="1.0.0");skin.print_banner()
