...
from cli_anything.algo_master.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_master.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-master",version="1.0.0");skin.print_banner()
