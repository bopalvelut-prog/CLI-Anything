...
from cli_anything.amb_nurse.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_nurse.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-nurse",version="1.0.0");skin.print_banner()
