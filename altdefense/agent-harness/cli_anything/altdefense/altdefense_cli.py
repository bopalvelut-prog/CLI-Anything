...
from cli_anything.altdefense.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altdefense.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altdefense",version="1.0.0");skin.print_banner()
