...
from cli_anything.ambdepartment.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambdepartment.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambdepartment",version="1.0.0");skin.print_banner()
