...
from cli_anything.algoconverter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algoconverter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algoconverter",version="1.0.0");skin.print_banner()
