...
from cli_anything.agri_list.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_list.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-list",version="1.0.0");skin.print_banner()
