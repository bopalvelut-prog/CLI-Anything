...
from cli_anything.altassociate.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altassociate.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altassociate",version="1.0.0");skin.print_banner()
