...
from cli_anything.amb_tool.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_tool.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-tool",version="1.0.0");skin.print_banner()
