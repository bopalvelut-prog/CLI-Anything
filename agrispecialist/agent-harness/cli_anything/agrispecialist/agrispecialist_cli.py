...
from cli_anything.agrispecialist.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agrispecialist.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agrispecialist",version="1.0.0");skin.print_banner()
