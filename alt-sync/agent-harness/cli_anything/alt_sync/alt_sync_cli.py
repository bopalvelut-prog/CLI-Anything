...
from cli_anything.alt_sync.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_sync.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-sync",version="1.0.0");skin.print_banner()
