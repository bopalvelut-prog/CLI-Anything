...
from cli_anything.ambteacher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambteacher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambteacher",version="1.0.0");skin.print_banner()
