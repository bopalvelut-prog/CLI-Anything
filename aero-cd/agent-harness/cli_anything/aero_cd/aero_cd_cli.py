...
from cli_anything.aero_cd.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_cd.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-cd",version="1.0.0");skin.print_banner()
