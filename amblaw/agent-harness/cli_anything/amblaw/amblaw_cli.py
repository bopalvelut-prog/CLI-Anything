...
from cli_anything.amblaw.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amblaw.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amblaw",version="1.0.0");skin.print_banner()
