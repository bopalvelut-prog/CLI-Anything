...
from cli_anything.agricloud.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agricloud.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agricloud",version="1.0.0");skin.print_banner()
