...
from cli_anything.alt_engineer.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_engineer.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-engineer",version="1.0.0");skin.print_banner()
