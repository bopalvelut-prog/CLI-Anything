...
from cli_anything.algo_captain.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_captain.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-captain",version="1.0.0");skin.print_banner()
