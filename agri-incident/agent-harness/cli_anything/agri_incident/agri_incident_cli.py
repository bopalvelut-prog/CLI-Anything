...
from cli_anything.agri_incident.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agri_incident.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agri-incident",version="1.0.0");skin.print_banner()
