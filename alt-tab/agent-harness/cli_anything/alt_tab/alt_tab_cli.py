...
from cli_anything.alt_tab.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_tab.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-tab",version="1.0.0");skin.print_banner()
