...
from cli_anything.altarchitect.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altarchitect.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altarchitect",version="1.0.0");skin.print_banner()
