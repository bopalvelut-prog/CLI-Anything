...
from cli_anything.amb_messenger.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_messenger.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-messenger",version="1.0.0");skin.print_banner()
