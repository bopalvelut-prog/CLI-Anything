...
from cli_anything.agriedge.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agriedge.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agriedge",version="1.0.0");skin.print_banner()
