...
from cli_anything.aero_decree.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_decree.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-decree",version="1.0.0");skin.print_banner()
