...
from cli_anything.altgetter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.altgetter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("altgetter",version="1.0.0");skin.print_banner()
