...
from cli_anything.aerobox.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aerobox.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aerobox",version="1.0.0");skin.print_banner()
