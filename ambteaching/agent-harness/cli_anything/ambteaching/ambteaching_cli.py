...
from cli_anything.ambteaching.core.session import Session
...
@handle_error
def repl():
    from cli_anything.ambteaching.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("ambteaching",version="1.0.0");skin.print_banner()
