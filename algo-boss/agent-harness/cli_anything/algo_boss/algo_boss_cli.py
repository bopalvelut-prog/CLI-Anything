...
from cli_anything.algo_boss.core.session import Session
...
@handle_error
def repl():
    from cli_anything.algo_boss.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("algo-boss",version="1.0.0");skin.print_banner()
