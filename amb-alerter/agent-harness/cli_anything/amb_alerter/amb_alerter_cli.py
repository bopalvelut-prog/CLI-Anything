...
from cli_anything.amb_alerter.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_alerter.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-alerter",version="1.0.0");skin.print_banner()
