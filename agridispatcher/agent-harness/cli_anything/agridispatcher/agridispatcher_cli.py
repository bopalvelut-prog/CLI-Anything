...
from cli_anything.agridispatcher.core.session import Session
...
@handle_error
def repl():
    from cli_anything.agridispatcher.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("agridispatcher",version="1.0.0");skin.print_banner()
