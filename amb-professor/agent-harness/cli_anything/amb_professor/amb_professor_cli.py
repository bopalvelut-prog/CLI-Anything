...
from cli_anything.amb_professor.core.session import Session
...
@handle_error
def repl():
    from cli_anything.amb_professor.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("amb-professor",version="1.0.0");skin.print_banner()
