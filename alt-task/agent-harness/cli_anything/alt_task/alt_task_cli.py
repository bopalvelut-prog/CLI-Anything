...
from cli_anything.alt_task.core.session import Session
...
@handle_error
def repl():
    from cli_anything.alt_task.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("alt-task",version="1.0.0");skin.print_banner()
