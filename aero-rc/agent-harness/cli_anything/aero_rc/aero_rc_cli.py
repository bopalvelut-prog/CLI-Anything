...
from cli_anything.aero_rc.core.session import Session
...
@handle_error
def repl():
    from cli_anything.aero_rc.utils.repl_skin import ReplSkin
    global _repl_mode;_repl_mode=True
    skin=ReplSkin("aero-rc",version="1.0.0");skin.print_banner()
